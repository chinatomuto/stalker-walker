...
//
  ...
  //  }
    ...
    func fetchIg(username: String) {
        let urlString = "https://instagram85.p.rapidapi.com/account/\(username)/info"
...
//    }
    ...
    func parseJSON(_ instagramData: Data) -> InstagramModel? {
        ...
        do {
            ...
            let following = decodedData.data.figures.followings
            let picture = decodedData.data.profile_picture.normal
            
            let instagram = InstagramModel(fullName: full_name, bio: biography, locked: locked, post: post, followers: followers, followings: following, profilePicture: picture)
